...
EventAction::EventAction(FILE* fp0,TFile* tf0, TTree* geotr, Int_t eventNum)
{
  ...
  testtree->Branch("TriggersVar10",pss.Trig2,"TriggersVar10/I");
  testtree->Branch("TriggersVar20",pss.Trig3);
  testtree->Branch("TriggersVar30",pss.Trig4);
...
void EventAction::EndOfEventAction(const G4Event* evt)
{
  ...
  std::cout<<"EdeptotL="<<EdeptotL<<std::endl;
  std::cout<<"nPhotonsNormL="<<nPhotonsNormL<<std::endl;
}
