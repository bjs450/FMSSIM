...
{
  defaultCutValue = 1*cm; //In parent class. gives default distance that must be covered by gamma, e-, e+ before certain processes are done to avoid infrared divergences //By default = 1mm
  SetVerboseLevel(0);
