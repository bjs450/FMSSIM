...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  //Tese scintillation properties are copied from N06, which is for water. BS CHANGE, delete them later
...
//  G4double polish = 0.8;
  ...
  */
  ...
  OpSurfaceL -> SetSigmaAlpha(0.01);
  OpSurfaceS -> SetSigmaAlpha(0.01);
